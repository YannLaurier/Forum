        ...
        <div class="container">
            <section id="user_info" class="flex between">
                ...
                <div class="flex column">
                    <?php
                    if (isset($_SESSION["user"])) {
                    if ($_SESSION["user"]["Pseudo"] === $thatGuy[0]["Pseudo"]) { ?>
                        ...
                        <dialog class="pad-10 popover" id="editProfileForm" aria-modal="true" popover>
                            <form method="POST" action="actions/editProfile.php" class="flex column">
                                ...
                                <textarea name="newDesc" id="newDesc" placeholder="Vous savez, moi je ne crois pas qu'il y ait de bonne ou de mauvaise situation. Moi, si je devais résumer ma vie aujourd'hui avec vous, je dirais que c'est d'abord des rencontres. Des gens qui m'ont tendu la main, peut-être...">
